...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ThriftServerSpec) DeepCopyInto(out *ThriftServerSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ThriftServerSpec.
func (in *ThriftServerSpec) DeepCopy() *ThriftServerSpec {
	if in == nil {
		return nil
	}
	out := new(ThriftServerSpec)
	in.DeepCopyInto(out)
	return out
}
